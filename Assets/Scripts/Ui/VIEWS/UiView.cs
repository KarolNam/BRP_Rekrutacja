...
public class UiView : MonoBehaviour
{
    ...
    public void DestroyView()
    {
        ...
        // selecting sender object if popUp destroyed
        if (this is PopUpView popUp && popUp.SenderReference != null && popUp.SenderReference.activeInHierarchy)
            EventSystem.current.SetSelectedGameObject(popUp.SenderReference);
